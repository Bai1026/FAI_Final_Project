...
logging.basicConfig(level=logging.INFO,
                    ...
                    handlers=[
                        logging.FileHandler("./results/q_learning/q_learning_training.log"),  # Output to file
...
if __name__ == "__main__":
    ...
    train_q_learning_with_baselines(q_learning_player, baseline_players, rounds_per_baseline=350)
    print('end')
